...
hist = model.fit(rnn_input, rnn_training, batch_size=600, epochs=500, 
...
def test_rnn (x1, y_test, plot_min, plot_max):
    ...
    print(mse(y_pred[20000], y_test[20000]))
   ...
   #         print('*****************************')
    ...
    #plt.ylabel('MSE from SRG Result')
    #ax.legend()
...
test_rnn(X_test1, y_test1, X_test1[0], X_test1[500])
